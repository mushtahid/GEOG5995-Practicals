...
def update(frame_number):
    ...
    # Calculate the total process time for the model. The print statement
    # for this is towards the end of the code.
...
# Total store value of all sheep
for i in range(len(sheep)):
...
with open('total_sheep_store.txt', 'a', newline='') as f:     
    store_writer = csv.writer(f, delimiter=' ')     
...
with open('total_wolves_store.txt', 'a', newline='') as f:     
    store_writer = csv.writer(f, delimiter=' ')     
    store_writer.writerow(t_wolves_store_list)

print('') #Add a blank space    
print(f"The model has run for {it_no} iterations, and ended")
